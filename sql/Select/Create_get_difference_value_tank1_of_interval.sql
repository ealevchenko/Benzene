...
/****** Object:  UserDefinedFunction [dbo].[get_difference_value_tank1_of_interval]    Script Date: 11.12.2020 21:23:49 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [dbo].[get_difference_value_tank1_of_interval]
 (
   @start datetime,
   @stop datetime
 )
